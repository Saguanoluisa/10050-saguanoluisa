		...
		while($row = $res->fetch_assoc()){
			...
			$html .= '
				<tr>
					...
					<td>' . $row['pais'] . '</td>
					<td class="text-center"><a href="marcas.php?d=' . $d_del_final . '"class="text-center btn" style="color:#000000; background-color:#FA0B00" ><b>Borrar</a></td>
					<td class="text-center"><a href="marcas.php?d=' . $d_act_final . '"class="text-center btn" style="color:#000000; background-color:#FAE617" ><b>Actualizar</a></td>
					<td class="text-center"><a href="marcas.php?d=' . $d_det_final . '"class="text-center btn" style="color:#000000; background-color:#33D6CB" ><b>Detalle</a></td>
				</tr>';
		}
		$html .= '<tr>
					<th class="text-center" colspan="8"><a href="../index.html" class="text-center btn" style="color:#f7f5f5; background-color:#6d96b3" ><b>Regresar</b></a></th>
